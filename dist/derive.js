...
exports.phrasePathToKey = void 0;
function phrasePathToKey(phrase, path) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("soon");
    });
}
exports.phrasePathToKey = phrasePathToKey;
// var Mnemonic = require('bitcore-mnemonic');
// import bitcoin from 'bitcoinjs-lib';
// let libs = {bitcoin}
// export const mnemonics = { "english": new Mnemonic("english") };
// export const mnemonic = mnemonics["english"];
// export function phrasePathToKey(phrase: any, path: any) {
//     return phraseToKey(phrase, 0, path)
// }
// export function phraseToKey(phrase: any, coinValue: number, path: string){
//     if (path) {
...
// }
// export function calculateAddressAndKey(coinValue: number, bip32RootKey: any, path: any) {
...
//     }
// }
// export function generateDerivationPath(coin: string){
//     var purpose =  44
//     var account = 0
//     var change = 0
//     var path = "m/";
...
//     return path
// }
// export function generateAccountDerivationPath(coin: string){
//     var purpose =  44
//     var account = 0
//     var path = "m/";
//     path += purpose + "'/";
...
//     return path
// }
// export function generateBip32ExtendedKey(path: string, bip32RootKey: any){
