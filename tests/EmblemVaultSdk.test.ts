...
const mocks = {
    emblemopen_create_template: {
        ...
        "targetContract": {
            ...
            "84532": "0x7B2F434E2F378D493599F9f23AA97f8f47540218",
            "name": "EmblemOpen",
            // NOTE: for a 'detailed' collection the reference site sets
            // targetContract.description to null. The SDK currently emits the
            // static collection description here (tracked as a separate fix).
            // When that lands, remove this line.
